...
def train(training_config):
    ...
    print(f'Entering the training loop. Logging frequency every {training_config["log_freq"]} batches.')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_freq", type=int, help="logging to output console frequency", default=1000)
